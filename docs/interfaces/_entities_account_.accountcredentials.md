[masto](../README.md) › [Globals](../globals.md) › ["entities/account"](../modules/_entities_account_.md) › [AccountCredentials](_entities_account_.accountcredentials.md)
...
*Defined in [src/entities/account.ts:68](https://github.com/neet/masto.js/blob/b9f6bdd/src/entities/account.ts#L68)*
