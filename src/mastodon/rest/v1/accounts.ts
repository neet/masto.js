...
export interface Accounts$SelectNoteResource {
   ...
   * @return Relationship
   */
  create: Endpoint<CreateAccountNoteParams, HttpMetaParams<"json">, Relationship>;
}
...
export interface AccountsResource {
   ...
   */
  create: Endpoint<CreateAccountParams, HttpMetaParams<"multipart-form">, Token>;
   ...
   * @see https://docs.joinmastodon.org/methods/accounts/
   */
  updateCredentials: Endpoint<UpdateCredentialsParams, HttpMetaParams<"multipart-form">, AccountCredentials>;
}
