...
describe("Missing v1 entity exports", () => {
  it("should export QuoteApproval types through mastodon.v1 namespace", () => {
    ...
    type QuoteApprovalPolicyTest = mastodon.v1.QuoteApprovalPolicy;
    type QuoteApprovalCurrentUserPolicyTest = mastodon.v1.QuoteApprovalCurrentUserPolicy;
  ...
  it("should export AccountWarning types through mastodon.v1 namespace", () => {
    ...
    type AccountWarningActionTest = mastodon.v1.AccountWarningAction;
  ...
  it("should export Appeal types through mastodon.v1 namespace", () => {
    ...
    type AppealStateTest = mastodon.v1.AppealState;
